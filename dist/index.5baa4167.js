...
(0, _uploadJs.upload)("#file", {
    ...
    onUpload (files, blocks) {
        files.forEach((file, index)=>{
            ...
            const task = (0, _storage.uploadBytesResumable)(storageRef, file);
            task.on("state_changed", (snapshot)=>{
                ...
                const pUrl = (0, _storage.getDownloadURL)(storageRef);
                pUrl.then((info)=>console.log("The url for " + file.name + " is " + info));
            });
        });
    }
});

},{"./upload.js":"idLKm","firebase/app":"aM3Fo","firebase/storage":"8WX7E"}],"idLKm":[function(require,module,exports) {
...
},{"@firebase/app":"3AcPV","@firebase/util":"ePiK6","@firebase/component":"bi1VB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hPIHA","igcvL"], "igcvL", "parcelRequire6329")
